...
#define TAG "AmourK08V2LCD"

LV_FONT_DECLARE(font_puhui_16_4);
LV_FONT_DECLARE(font_awesome_16_4);

class AmourK08V2LCD : public WifiBoard {
private:
    ...
    void InitializePowerSaveTimer() {
        ...
        power_save_timer_->OnEnterSleepMode([this]() {
            ...
            _brightness = GetBacklight()->brightness(); //保存当前亮度
        ...
        power_save_timer_->OnExitSleepMode([this]() {
            ...
            GetBacklight()->SetBrightness(_brightness); //恢复亮度
...
public:
    AmourK08V2LCD() :
        ...
        InitializeButtons();
        InitializeIot();
        power_manager_ = new PowerManager(BATTERY_CHARGE_STATUS_PIN, POWER_HOLD_PIN, i2c_bus_);
    ...
    virtual bool GetBatteryLevel(int &level, bool& charging, bool& discharging) override {
        ...
        ESP_LOGI(TAG, "GetBatteryLevel: %d, charging: %d, discharging: %d", level, charging, discharging);
        return true;
    }
